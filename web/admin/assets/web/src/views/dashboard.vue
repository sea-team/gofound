            ...
            <div id="dashboard">
                <el-card style="margin-bottom:20px;">
                    <div style="display:flex;justify-content: space-between">
                        ...
                        <div v-cloak>
                            <el-button style="margin-left:10px;" type="danger" @click="drop()" plain icon="close">删除
                            </el-button>
                            <el-button style="margin-left:10px;" type="success" @click="search()" icon="refresh">刷新
                            </el-button>
                        </div>
                    </div>
                ...
                <el-card>
                    <template #header>
                        ...
                        <div class="header">
                            <div style="display:flex;justify-content:space-between">
                                <el-button icon="plus" type="success" style="margin-right:10px" @click="addIndex()">
                                    添加索引
                                </el-button>
                                <div>
                                    <el-input @keyup.enter="search()" v-model="params.query"
                    ...
                    <div v-if="data">
                        <el-alert type="success" style="margin-bottom:10px;">
                            <div>
                                查询耗时：{{ data.time }}ms，找到：{{ data.total }}个结果，每页{{
                                params.limit
                                }}条，总共{{ data.pageCount }}页
                            </div>
                            <div>
                                <b>分词结果：</b>
                            </div>
                            <div>
                                <el-tag style="margin-right: 10px;" v-for="item in data.words" v-text="item"
                                        :key="item"></el-tag>
                            </div>
                        </el-alert>
                    </div>
                    ...
                    <el-table :stripe="true" v-loading="loading" :data="tableData" style="width: 100%"
                        ...
                        <el-table-column fixed="right" prop="operation" label="Operation" width="100">
                            <template #default="scope">
                                <el-link @click="updateRow(scope.row)" type="primary" style="margin-right:10px;">修改
                                </el-link>
